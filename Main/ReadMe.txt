========================================================================
		ActiveX Control DLL : MEDIA
========================================================================

ControlWizard has created this project for your MEDIA ActiveX Control
...
that make up your MEDIA ActiveX Control DLL.
...
MediaCtl.h
	This file contains the declaration of the CMediaCtrl C++ class.

MediaCtl.cpp
	This file contains the implementation of the CMediaCtrl C++ class.

MediaPpg.h
	This file contains the declaration of the CMediaPropPage C++ class.

MediaPpg.cpp
	This file contains the implementation of the CMediaPropPage C++ class.

MediaCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CMediaCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Media.rc.
